...
First observation: I saw `r n_obs` Prii in 10 minutes -- that strikes me as a lot! I make no attempt to calculate the total number of Prii in Boulder from these observations, but that seems like a possible feat with some effort.

...
## beta   0.03    0.00 0.01   0.02   0.02   0.03   0.03   0.04  1516    1
## lp__ -82.17    0.02 0.71 -84.08 -82.34 -81.90 -81.71 -81.65  1576    1
## 
## Samples were drawn using NUTS(diag_e) at Fri Sep  1 15:23:14 2017.
...
So there's a 95% chance the expected wait time between Prius spottings is between 23 and 58 seconds.
...
There's a ~0.24% probability of simulated data having variation greater than the observed. This isn't too far off. The nearer to 50%, the more consistent the simulated data and observed. The exponential distribution model as-is seems fairly adequate.
